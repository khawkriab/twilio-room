...
describe('the useHandleRoomDisconnectionErrors hook', () => {
  ...
  it('should tear down old listeners when receiving a new room', () => {
    ...
    const { rerender } = renderHook(() => useHandleRoomDisconnectionErrors(mockRoom, () => {/* call back */ }));
  ...
  it('should clean up listeners on unmount', () => {
    const { unmount } = renderHook(() => useHandleRoomDisconnectionErrors(mockRoom, () => {/* call back */ }));
    unmount();
